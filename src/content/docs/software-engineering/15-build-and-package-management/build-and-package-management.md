...
- **[Library (computing) — Wikipedia](/computer-science-notes/<https://en.wikipedia.org/wiki/Library_(computing)>)**
...
- **Dependency Resolution**: Package manager analyze each dependency of different packages. They examine the version requirements and constraints specified by each package and attempt to find a compatible set of versions that satisfy all dependencies. It can construct a [directed graph](/computer-science-notes/data-structures-and-algorithms/graph) to represent the dependency structure. It then uses algorithm such as [cycle detection](/computer-science-notes/data-structures-and-algorithms/cycle-detection) and [topological sort](/computer-science-notes/data-structures-and-algorithms/topological-sort) to identify circular dependencies and determine the correct order to install dependencies.
...
:::info
An example of package manager is [npm](/computer-science-notes/internet-and-web/javascript#npm), which is the default package manager for [Node.js](/computer-science-notes/internet-and-web/javascript#node-js) projects.
:::
...
- **[Compilation](/computer-science-notes/compilers-and-programming-languages/cpl-fundamentals#compiler-toolchain)**: Translating human-readable source code into machine-readable code, or intermediate language in the case of [interpreted languages](/computer-science-notes/computer-and-programming-fundamentals/interpreter).
