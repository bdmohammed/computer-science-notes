...
- **Scalability**: Modularization follows the [separation of concerns](/computer-science-notes/software-engineering/software-principles#separation-of-concerns-soc) principle, making it [loosely coupled](/computer-science-notes/software-engineering/software-principles#coupling--cohesion) and flexible to be extended or modified.
...
See [Dependency inversion principle (DIP)](/computer-science-notes/software-engineering/software-principles#dependency-inversion-principle-dip).
