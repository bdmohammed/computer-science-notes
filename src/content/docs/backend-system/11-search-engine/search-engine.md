...
- **[Caching](/computer-science-notes/computer-and-programming-fundamentals/caching)**: Caching is a technique where frequently accessed search results or frequently executed queries are stored in memory for faster retrieval.
...
- **Database Search Engine**: These search engines focus on searching within structured databases. They enable users to query and retrieve specific data from databases using [SQL-like queries](/computer-science-notes/database-system/query-language) or other query languages.

### Elasticsearch

**Elasticsearch** is a search and analytics engine, at its core, it is a [document-oriented database](/computer-science-notes/database-system/nosql#document) that stores data in [JSON](/computer-science-notes/digital-media-processing/json)-like format. It allows you to index and search structured and unstructured data, making it suitable for many use cases such as full-text search, log analytics, and real-time analytics.
...
:::tip
See also [search engine on internet and web](/computer-science-notes/internet-and-web/search-engine).
:::
