...
:::info
SOAP is not very used in modern days, using XML may add complexity for a relatively simple use case. [REST API](/computer-science-notes/backend-system/rest-api) is more used due to its better performance, XML parsing can be slower than [JSON](/computer-science-notes/digital-media-processing/json) data format as JSON has a simpler structure and syntax.
:::
