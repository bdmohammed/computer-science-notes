...
**Linux** is a free and open-source, multitasking, Unix-like [operating system kernel](/computer-science-notes/operating-system/kernel). It was created by Linus Torvalds in 1991, Linux was developed as a free and open alternative to proprietary operating systems.
...
The Linux kernel is based on [Unix](/computer-science-notes/operating-system/unix), they have similar features. For system calls, take a look at [type of system calls & example](/computer-science-notes/operating-system/system-call#type-of-system-calls--example).
...
- Linux manages physical memory by classifying memory into several zones, where their boundaries depend on the system architecture.
  ...
  - **DMA Zone**: This zone is dedicated to [direct memory access (DMA)](/computer-science-notes/computer-organization-and-architecture/input-output#dma) operations, where devices can access memory directly without CPU intervention.
...
- Linux implements a [virtual memory](/computer-science-notes/operating-system/memory-management#virtual-memory) system that allows processes to have their own virtual address spaces. It provides memory protection, demand paging, and memory sharing mechanisms.
- Linux kernel uses the [slab](/computer-science-notes/operating-system/memory-management#slab-allocation) and the [buddy allocation](/computer-science-notes/operating-system/memory-management#buddy-allocation).

#### File Systems

- Linux supports various file systems, including [ext4](/computer-science-notes/operating-system/file-system#ext4), XFS, Btrfs, [FAT](/computer-science-notes/operating-system/file-system#fat), [NTFS](/computer-science-notes/operating-system/file-system#ntfs), and more.
...
- For alternative of wait queues in asynchronous events communication, Linux also implement [semaphore](/computer-science-notes/operating-system/multithreading#semaphores).
- For passing message among processes, Linux provide [shared memory](/computer-science-notes/operating-system/inter-process-communication#shared-memory) and [pipe message passing](/computer-science-notes/operating-system/inter-process-communication#message-passing) mechanism.
...
- Linux kernel supports a wide range of network protocols, including [TCP/IP](/computer-science-notes/computer-networking/tcp-protocol), [UDP](/computer-science-notes/computer-networking/udp), ICMP, [IPv4](/computer-science-notes/computer-networking/ip-address#ipv4), and [IPv6](/computer-science-notes/computer-networking/ip-address#ipv6). It also provides support for network services like [DNS](/computer-science-notes/computer-networking/dns), [DHCP](/computer-science-notes/computer-networking/dhcp), and [NAT](/computer-science-notes/computer-networking/nat).
...
- Linux implements a file and directory access permissions. The kernel supports [Access Control Lists (ACLs)](/computer-science-notes/operating-system/protection-and-security#access-control) and Security-Enhanced Linux (SELinux), which provide additional layers of access control and security policies.
