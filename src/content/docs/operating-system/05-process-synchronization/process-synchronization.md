...
Process synchronization is concerned with the coordination and control of concurrent processes or threads in a system. The goal is to ensure that processes can safely access shared resources, communicate with each other, and avoid other [concurrency-related issues](/computer-science-notes/operating-system/multithreading#multithreading-problems).

### Synchronization Techniques

Some concept of synchronization for process is similar to [thread synchronization](/computer-science-notes/operating-system/multithreading#thread-synchronization), that is using synchronization tools such as mutexes, condition variables, semaphores, etc.
...
The dining philosophers problem illustrate the [deadlock](/computer-science-notes/operating-system/multithreading#multithreading-problems).
...
The solution for this problem uses [monitors](/computer-science-notes/operating-system/multithreading#monitor--condition-variables):
