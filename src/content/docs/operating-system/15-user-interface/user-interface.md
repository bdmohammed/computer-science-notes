...
- **[Shell (computing) — Wikipedia](/computer-science-notes/<https://en.wikipedia.org/wiki/Shell_(computing)>)**
...
:::info
See also [command line vs shell](/computer-science-notes/computer-and-programming-fundamentals/computer-and-programming-terminology#command-line-command-prompt-shell-bash-terminal-console)
:::
...
One of the popular pattern for designing a GUI system is the **[Model-View-Controller (MVC)](/computer-science-notes/software-engineering/other-architecture-patterns#mvc)** pattern. This pattern design GUI system in three separate components.
