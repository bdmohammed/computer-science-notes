...
The design principles and features of Unix make it popular. As a result, many other OS starts to adopt similar design principles and features with Unix, leading to the emergence of so called "Unix-like systems". Unix-like system, such as [Linux](/computer-science-notes/operating-system/linux-kernel) and [BSD](/computer-science-notes/operating-system/bsd), shares many fundamental concepts and system calls with Unix. The portability aspect of Unix also make it compatible with Unix-like systems.
...
- The kernel layer wraps hardware layer, it handles low-level tasks such as [process management](/computer-science-notes/operating-system/process-management), [memory management](/computer-science-notes/operating-system/memory-management), [file system management](/computer-science-notes/operating-system/file-system), [device driver interfaces](/computer-science-notes/operating-system/device-management), and scheduling of system resources.
- Beyond the kernel, there exist the interface layer. This layer contains command ([shell](/computer-science-notes/operating-system/user-interface#cli)) and set of [system call interface](/computer-science-notes/operating-system/system-call#system-call-interface) that allows program to request services from the kernel, such as creating processes, accessing files, and managing memory.
...
- **Shell**: Unix provides shell that serves as a [command-line interface (CLI)](/computer-science-notes/operating-system/user-interface#cli) for interacting with the system. The shell interprets user commands and executes them, allowing users to perform various operations, run programs, and manage files and processes.
...
- **Hierarchical File System**: UNIX uses a hierarchical file system, where files and directories are organized in a tree-like structure, with one root directory (the "/"), and [inode](/computer-science-notes/operating-system/file-system#ext2) as the data structure of a file system object.
...
- [**Inter-process Communication**](/computer-science-notes/operating-system/inter-process-communication): Uses of [pipes](/computer-science-notes/operating-system/inter-process-communication#message-passing) as its IPC mechanism. For example, the command `command1 | command2` creates a pipe between `command1` and `command2`, where the output of `command1` is piped directly as input to `command2`.
- **System Calls**: See [type of system calls & example](/computer-science-notes/operating-system/system-call#type-of-system-calls--example).
