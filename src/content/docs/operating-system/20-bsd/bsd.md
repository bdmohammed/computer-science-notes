...
**Berkeley Software Distribution (BSD)** is a family of [Unix-like operating systems](/computer-science-notes/operating-system/unix) that originated from the Unix research and development work conducted at the University of California, Berkeley in the 1970s and 1980s.
...
The FreeBSD is an open source, portable, complete operating system that can run on [x86](/computer-science-notes/computer-organization-and-architecture/isa#x86), [ARM](/computer-science-notes/computer-organization-and-architecture/isa#arm), AArch64, RISC-V, and PowerPC computers.

FreeBSD features:

- **Kernel**: FreeBSD has its own kernel, which is a monolithic one with modular design.

  The kernel initially uses the M:N [threading model](/computer-science-notes/operating-system/multithreading#relationship-model), where multiple user-level threads (M) were mapped onto a smaller number of kernel-level threads (N). In the version 7.0, FreeBSD switched to a 1:1 threading model.
...
- **File Systems**: FreeBSD supports various file systems, including UFS (Unix File System), ZFS (Zettabyte File System), and [FAT (File Allocation Table)](/computer-science-notes/operating-system/file-system#fat).
- **Networking**: FreeBSD has a robust networking stack that includes support for [TCP/IP](/computer-science-notes/computer-networking/tcp-protocol), [IPv6](/computer-science-notes/computer-networking/ip-address#ipv6), [routing](/computer-science-notes/computer-networking/routing), [firewall](/computer-science-notes/computer-security/network-security#firewall), and [Wi-Fi](/computer-science-notes/computer-networking/wi-fi).
- **Jails**: FreeBSD introduced the concept of "jails," which are a form of [operating system-level](/computer-science-notes/cloud-computing-and-distributed-systems/virtualization#level-implementation) [virtualization](/computer-science-notes/cloud-computing-and-distributed-systems/virtualization). Jails allow the creation of isolated environments within a single FreeBSD installation, providing secure separation of processes, file systems, and network stacks.
