...
Before executing the interrupt handler, the hardware typically perform [context switch](/computer-science-notes/operating-system/process-management#context-switch) to save the current execution context, including the values of registers, program counters, and other relevant processor state information to be resumed on later.
