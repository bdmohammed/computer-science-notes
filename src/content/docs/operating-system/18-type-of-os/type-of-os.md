...
- **Virtualization OS**: These operating systems provide [virtualization](/computer-science-notes/cloud-computing-and-distributed-systems/virtualization) capabilities to enable multiple virtual machines to run on a single physical machine. Examples include VMware ESXi, Microsoft Hyper-V, and Xen.
