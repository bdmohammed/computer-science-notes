...
2.  **Color Space**: Represent how the color are represented, such as RGB, RGBA, CMYK, HSV or grayscale. See also [color representation](/computer-science-notes/computer-and-programming-fundamentals/data-representation#color).
...
4.  **Image Format**: The image format used, such as [JPEG](/computer-science-notes/digital-media-processing/jpg-jpeg), [PNG](/computer-science-notes/digital-media-processing/png), [BMP](/computer-science-notes/digital-media-processing/bmp), TIFF, [GIF](/computer-science-notes/digital-media-processing/gif), or RAW. They represent different feature and compression methods (if any).
...
:::tip
See also [computer display](/computer-science-notes/computer-graphics/computer-display).
:::
