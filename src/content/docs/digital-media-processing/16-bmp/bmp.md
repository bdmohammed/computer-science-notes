...
**Bitmap (BMP)** is a [raster image format](/computer-science-notes/computer-graphics/computer-images-part-1) that stores pixel data for an image. BMP stores pixel data in binary format. BMP are generally uncompressed, meaning the original data doesn't undergo [compression](/computer-science-notes/digital-signal-processing/compression) process.
