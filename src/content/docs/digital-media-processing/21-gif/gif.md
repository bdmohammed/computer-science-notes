...
**GIF (Graphics Interchange Format)** is a digital image format that supports both static and animated images. GIF also supports transparency and uses [lossless compression](/computer-science-notes/digital-signal-processing/compression#lossless-compression).

### GIF Representation

#### GIF Color Palette

GIF uses an [indexed color palette](/computer-science-notes/digital-media-processing/bmp#indexed-color), similar to [BMP](/computer-science-notes/digital-media-processing/bmp).
