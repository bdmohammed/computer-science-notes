...
**WebP** is an image format developed by Google that provides both [lossy](/computer-science-notes/digital-signal-processing/compression#lossless-compression/digital-signal-processing/compression#lossy-compression) and [lossless compression](/computer-science-notes/digital-signal-processing/compression#lossless-compression) for digital images. WebP is better suited for webpages than [JPG](/computer-science-notes/digital-media-processing/jpg-jpeg) due to its better compression efficiency, which reduces file size and improve performance. WebP is supported by browser natively, support image transparency, and animation through the WebP Animation format (WebPANIM).
...
WebP uses similar technique as [JPG compression](/computer-science-notes/digital-media-processing/jpg-jpeg#jpg-compression) with small difference.
