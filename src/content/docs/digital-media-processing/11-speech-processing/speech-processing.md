...
**Speech processing** is the analysis, synthesis, and understanding of spoken language. It involves various techniques and algorithms including speech recognition, speech synthesis, speaker recognition, and speech enhancement. Speech processing involves a lot of [machine learning](/computer-science-notes/machine-learning-intro) and [deep learning](/computer-science-notes/deep-learning-intro) techniques.
...
2. **Pre-processing**: Digital signal is then pre-processed, this may include enhancing quality, such as [filtering](/computer-science-notes/digital-signal-processing/filtering), [noise reduction](/computer-science-notes/digital-signal-processing/denoising), and removing unwanted elements like background noise.
...
:::tip
See also [natural language processing (NLP)](/computer-science-notes/deep-learning/deep-learning-tasks#natural-language-processing-nlp).
:::
