...
**MP4 (MPEG-4 Part 14)** is a digital [multimedia container](/computer-science-notes/digital-media-processing/ogg-vorbis#media-container) format, commonly used to store audio and video data.
...
H.264, also known as AVC (Advanced Video Coding), is the most commonly used [lossy video compression](/computer-science-notes/digital-signal-processing/compression#lossy-compression) standard.
