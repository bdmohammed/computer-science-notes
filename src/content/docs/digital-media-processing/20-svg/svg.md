...
**SVG (Scalable Vector Graphics)** is an [XML](/computer-science-notes/digital-media-processing/xml)-based [vector image format](/computer-science-notes/computer-graphics/computer-images-part-1) used to display two-dimensional graphics on the web. SVG images are resolution-independent, meaning they can be scaled up or down without losing quality.
