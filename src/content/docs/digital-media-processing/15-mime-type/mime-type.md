...
- `subtype` is the specific format of the data, such as [plain text](/computer-science-notes/digital-media-processing/txt), [HTML](/computer-science-notes/internet-and-web/html), [PDF](/computer-science-notes/digital-media-processing/pdf), MS Word document.
- `suffix` is an optional suffix that can be used to represent specific structure of the format. For example, the suffix `xml` can be used to classify [XML data](/computer-science-notes/digital-media-processing/xml), and the suffix `json` can be used to classify [JSON](/computer-science-notes/digital-media-processing/json) data.
...
For example, a MIME type for [JPEG](/computer-science-notes/digital-media-processing/jpg-jpeg) file is `image/jpeg; charset=utf-8`

Other examples:

- `text/plain`: plain text
- `image/jpeg`: JPEG images
- `audio/mp3`: [MP3 audio](/computer-science-notes/digital-media-processing/mp3)
- `video/mp4`: [MP4 videos](/computer-science-notes/digital-media-processing/mp4)
