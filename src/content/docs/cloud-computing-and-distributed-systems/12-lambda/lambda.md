...
2. **Windowing**: Data can be processed in [window](/computer-science-notes/data-structures-and-algorithms/sliding-window), a way to group similar or related data within specific time intervals or fixed-size data subsets.
