...
- **Function Pricing**: For [FaaS](/computer-science-notes/cloud-computing-and-distributed-systems/cloud-models#more-models) services, the pricing can be based on the number of function invocations and the execution duration.
...
- **Amazon RDS**: Managed [relational database](/computer-science-notes/database-system/relational-data) service
- **Amazon VPC**: Virtual private cloud for networking
- **Amazon SNS**: Simple Notification Service for messaging and notifications
- **Amazon SQS**: Simple Queue Service for [message queuing](/computer-science-notes/backend-system/message-broker)
- **Amazon DynamoDB**: Fully managed [NoSQL database](/computer-science-notes/database-system/nosql)
- **Amazon CloudFront**: [Content delivery network (CDN)](/computer-science-notes/software-engineering/system-design#cdn)
- **Amazon Route 53**: Scalable [domain name system (DNS)](/computer-science-notes/computer-networking/dns) web service
- **Amazon Lambda**: [Serverless](/computer-science-notes/backend-system/serverless) compute service
- **Amazon Redshift**: Fully managed data warehouse
- **Amazon Elastic Beanstalk**: [Platform as a Service (PaaS)](/computer-science-notes/cloud-computing-and-distributed-systems/cloud-models#common-models) for deploying and managing applications
...
- **Google Kubernetes Engine**: Managed [Kubernetes](/computer-science-notes/cloud-computing-and-distributed-systems/docker-and-kubernetes#kubernetes) service for container orchestration
