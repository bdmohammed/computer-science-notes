...
There are many types of formal grammar, the types of grammar based on [Noam Chomsky](https://en.wikipedia.org/wiki/Noam_Chomsky) are [regular grammar](#regular-grammar), [context-free grammar](/computer-science-notes/theory-of-computation-and-automata/context-free-grammar), context-sensitive grammar, and unrestricted grammar.
...
As explained in [grammar](/computer-science-notes/theory-of-computation-and-automata/toc-fundamentals#grammar), in general, a grammar is defined as quadruple: $G = (V, T, S, P)$.
...
Regular grammar is the grammar that describes [regular language](/computer-science-notes/theory-of-computation-and-automata/regular-languages-part-1), which is the languages recognized by finite automaton like [DFAs](/computer-science-notes/theory-of-computation-and-automata/finite-automata#dfa) and [NFAs](/computer-science-notes/theory-of-computation-and-automata/finite-automata#nfa).
...
See the [next topic](/computer-science-notes/theory-of-computation-and-automata/context-free-grammar).
