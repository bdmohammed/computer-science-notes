...
See [graph](/computer-science-notes/data-structures-and-algorithms/graph) for terminologies and types of graph. In addition, we can say a graph is a [tree](/computer-science-notes/data-structures-and-algorithms/tree) if it is connected and has no simple cycles.
...
See [boolean logic](/computer-science-notes/computer-organization-and-architecture/boolean-logic).
...
:::tip
See also [Formal grammar](/computer-science-notes/theory-of-computation-and-automata/formal-grammar).
:::
