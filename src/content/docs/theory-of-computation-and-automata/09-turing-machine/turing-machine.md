...
This particular example is quite simple, as the input language is just [regular language](/computer-science-notes/theory-of-computation-and-automata/regular-languages-part-1) that can even be recognized by a [finite automaton](/computer-science-notes/theory-of-computation-and-automata/finite-automata). The visual notation of this Turing machine is explained in [rules](#rules).
...
This example is more complex, as it requires memory to keep track of the number $N$, which finite automata can't. A [pushdown automata](/computer-science-notes/theory-of-computation-and-automata/pushdown-automata) would work for this, we don't even need to use the full power of Turing machine to recognize this language.
...
Nondeterministic Turing machine incorporates nondeterminism to Turing machine, just like how [NFA](/computer-science-notes/theory-of-computation-and-automata/finite-automata#nfa) to [DFA](/computer-science-notes/theory-of-computation-and-automata/finite-automata#dfa).
...
1. **Regular Language**: These languages are represented by [regular grammar](/computer-science-notes/theory-of-computation-and-automata/formal-grammar#regular-grammar) and can be recognized by [finite automata](/computer-science-notes/theory-of-computation-and-automata/finite-automata).
2. **Context-Free Language**: Recognized by [pushdown automata](/computer-science-notes/theory-of-computation-and-automata/pushdown-automata), represented by [context-free grammar](/computer-science-notes/theory-of-computation-and-automata/context-free-grammar).
