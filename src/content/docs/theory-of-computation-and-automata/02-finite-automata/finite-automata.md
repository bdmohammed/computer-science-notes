...
:::info
When referring to language, string, and other terminologies, we are referring to those explained in [TOC Fundamentals](/computer-science-notes/theory-of-computation-and-automata/toc-fundamentals).
:::
...
A complex example of acceptors is a [compiler](/computer-science-notes/compilers-and-programming-languages-intro). It is a program that determine whether a code from certain programming language follows the grammar rules and syntax of that language.
...
This NFA is similar to [this DFA version](/computer-science-notes/theory-of-computation-and-automata/finite-automata#dfa-with-self-loop-and-dead-state).
...
Another example, related to [this](/computer-science-notes/theory-of-computation-and-automata/finite-automata#dfa-with-the-same-transition-function-across-different-inputs), we don't need to include the dead state beyond state $C$.
