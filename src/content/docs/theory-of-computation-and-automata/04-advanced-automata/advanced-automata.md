...
- $\delta: Q \times \Sigma \rightarrow Q$: Similar to [normal DFA](/computer-science-notes/theory-of-computation-and-automata/finite-automata#dfa), takes a state and alphabet, returns a new state
