...
The creation of socket takes what type of [IP address](/computer-science-notes/computer-networking/ip-address) to use (IPv4 or IPv6) and which type of socket to use. The type of socket refers to what protocol is used to transfer data. Socket provide reliable data transfer by using protocols like [Transmission Control Protocol (TCP)](/computer-science-notes/computer-networking/tcp-protocol) and [User Datagram Protocol (UDP)](/computer-science-notes/computer-networking/udp).
