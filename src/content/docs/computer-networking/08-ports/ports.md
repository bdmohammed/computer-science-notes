...
- **[Port (computer networking) — Wikipedia](/computer-science-notes/<https://en.wikipedia.org/wiki/Port_(computer_networking)>)**
...
**Ports** is a number that identify communication endpoint that allows a computer to send and receive data over a network. Ports is used in two common protocols: [TCP](/computer-science-notes/computer-networking/tcp-protocol) and [UDP](/computer-science-notes/computer-networking/udp).
...
- **Filtered**: If a port does not respond to the scan or the response is blocked by a [firewall](/computer-science-notes/computer-security/network-security#firewall) or network filtering device, it is considered filtered. The port scanner cannot determine whether the port is open or closed.
...
:::tip
Find out about [TCP](/computer-science-notes/computer-networking/tcp-protocol) and [UDP](/computer-science-notes/computer-networking/udp)
:::
