...
**Advanced Encryption Standard (AES)** is a widely used [symmetric encryption](/computer-science-notes/computer-security/encryption#symmetric--asymmetric-encryption) algorithm, it is the replacement for [DES algorithm](/computer-science-notes/computer-security/des). By symmetric encryption, a shared [private key](/computer-science-notes/computer-security/encryption#public--private-key) is used to encrypt and decrypt the data. AES itself supports 128, 192, or 256-bit key, where the security of an AES system increases exponentially with key length.
...
The larger the key size, the more combinations an attacker needs to try, which is more resistant to [brute-force attacks](/computer-science-notes/computer-security/other-attack-and-exploit#brute-forcing).
...
2. **Initial Round**: The input data (plaintext) is combined with the first round key using a [bitwise XOR operation](/computer-science-notes/computer-and-programming-fundamentals/bitwise-operation#xor).
