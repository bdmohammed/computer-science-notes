...
**Digital Signature Algorithm (DSA)** is a [public key cryptography](/computer-science-notes/computer-security/encryption#public--private-key) or [asymmetric cryptography](/computer-science-notes/computer-security/encryption#symmetric--asymmetric-encryption) algorithm used for digital signatures. Digital signature is like a real physical signature, it is used to ensure integrity and origin of digital data.

DSA is based on the mathematical concept of [modular exponentiation](/computer-science-notes/computer-security/math-concepts#modular-exponentiation) and the difficulty of solving the discrete logarithm problem. DSA and [Diffie-Hellman key exchange](/computer-science-notes/computer-security/diffie-hellman) both rely on the computational difficulty of the discrete logarithm problem.
...
1. **Key Generation**:
   ...
   - Choose parameters:
     ...
     - Choose a [hash function](/computer-science-notes/computer-security/hash-function) $H$ with output length of $|H|$ bits (e.g., [SHA-1](/computer-science-notes/computer-security/sha#sha-1) or [SHA-2](/computer-science-notes/computer-security/sha#sha-2)).
