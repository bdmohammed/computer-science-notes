...
- **[Computer Graphics Images (part 1)](/computer-science-notes/computer-graphics/computer-images-part-1)**
...
Various amount of file format can be found in [digital media processing](/computer-science-notes/digital-media-processing-intro), digital media formats section.
...
- **Hexadecimal Color**: Hexadecimal color is another commonly used representation for colors in computer systems. It uses the [hexadecimal numbering system](/computer-science-notes/computer-and-programming-fundamentals/number-system#hexadecimal) to represent colors, where each color component is represented by a two-digit hexadecimal value ranging from 00 to FF.
...
As explained before, the stored file will be in a specific file format. In the case of sound or audio file, we can store it in [MP3 format](/computer-science-notes/digital-media-processing/mp3). By using the MP3 format, audio files can be efficiently stored, transferred, and played back on various digital devices.

![Sound sample](./sound-sample.png)  
Source: https://www.teachwithict.com/binary-representation-of-sound.html

:::tip
Know more about wave in computer in [digital signal processing](/computer-science-notes/digital-signal-processing-intro), especially the signal transmission part. More about [digital media processing](/computer-science-notes/digital-media-processing-intro).
:::
...
:::tip
See also [database system](/computer-science-notes/database-system-intro).
:::
...
Unicode assigns a unique numerical value, called a **code point**, to each character in its repertoire. The code points are represented using [hexadecimal notation](/computer-science-notes/computer-and-programming-fundamentals/number-system#hexadecimal), such as U+0041 for the uppercase letter "A" and U+4E2D for the Chinese character "中".
