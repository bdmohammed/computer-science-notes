...
[B-tree](/computer-science-notes/data-structures-and-algorithms/tree#b-tree) is a common data structure used to implement database index and the specific variant used is the **b+ tree**.
...
[Hash table](/computer-science-notes/data-structures-and-algorithms/hash-table) is another option for creating index.
