...
:::tip
Find more about [memory hierarchy](/computer-science-notes/computer-organization-and-architecture/registers-and-ram#memory-hierarchy).
:::

### Disks

Database operates in main memory and secondary storage. The main memory is typically abstracted by [file system](/computer-science-notes/operating-system/file-system) and [virtual memory](/computer-science-notes/operating-system/memory-management#virtual-memory).
...
:::tip
Find more about [disk management](/computer-science-notes/operating-system/disk-management).
:::
