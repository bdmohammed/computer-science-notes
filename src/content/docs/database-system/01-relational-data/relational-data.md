...
**Query** is a request or command made to retrieve or manipulate data stored in a database. It is a structured statement or set of instructions written in a [database query language](/computer-science-notes/database-system/query-language), used to communicate with an RDBMS.
...
:::info
More about [operation](/computer-science-notes/database-system/query-language#other-operations).
:::
