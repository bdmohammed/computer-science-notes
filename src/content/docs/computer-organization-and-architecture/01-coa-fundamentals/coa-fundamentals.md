...
- **Arithmetic Logic Unit (ALU)**: ALU is the component that is responsible for performing arithmetic operations (addition, subtraction, multiplication, and division) and logical operations (such as comparisons, [bitwise operations](/computer-science-notes/computer-and-programming-fundamentals/bitwise-operation), and [boolean operations](/computer-science-notes/computer-organization-and-architecture/boolean-logic)). The ALU operates on data retrieved from registers and produces results that are stored back in registers.
...
- **[Bootstrap Loader](/computer-science-notes/operating-system/booting)**: It is the initial instruction for computer to boot or start up.
...
- [Binary number system](/computer-science-notes/computer-and-programming-fundamentals/number-system#binary), includes how can we store and represent number with binary.
- [Binary representation](/computer-science-notes/computer-and-programming-fundamentals/binary-representation), includes binary operation.
- [Floating-number representation](/computer-science-notes/computer-and-programming-fundamentals/floating-number), includes how can computer represent real number.
- [Data representation](/computer-science-notes/computer-and-programming-fundamentals/data-representation), includes how computers represent data like character (e.g., ASCII, UTF), color, database.
