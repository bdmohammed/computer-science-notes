...
- **[Data Structures & Algorithms — Computer & Programming Fundamentals (with some rephrasing)](/computer-science-notes/computer-and-programming-fundamentals/data-structures-and-algorithms#basic-type-of-algorithm)**

**Search algorithms** are algorithm that is used to locate a specific item or element within a collection of data. The collection of data can take various forms, such as an [array](/computer-science-notes/data-structures-and-algorithms/array), [list](/computer-science-notes/data-structures-and-algorithms/linked-list), [tree](/computer-science-notes/data-structures-and-algorithms/tree), [graph](/computer-science-notes/data-structures-and-algorithms/graph), or any other data structure.

This note explains the simple linear and binary search algorithm, other search algorithm for more complex data structure are explained in the other notes. (e.g., [searching in tree with DFS](/computer-science-notes/data-structures-and-algorithms/traversal#tree-traversal)).
