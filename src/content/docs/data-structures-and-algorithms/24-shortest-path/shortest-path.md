...
**Dijkstra's Algorithm** is a popular algorithm to find the shortest path between a source vertex to **all the other vertex** in a [weighted graph](/computer-science-notes/data-structures-and-algorithms/graph#weighted). Dijkstra's algorithm works by exploring the graph from the source to each target, the cost of each traversal between nodes is kept track.
...
The systematic behavior of Dijkstra's algorithm is similar to [BFS traversal](/computer-science-notes/data-structures-and-algorithms/traversal#breadth-first-search-bfs), it uses a [queue data structure](/computer-science-notes/data-structures-and-algorithms/queue), specifically the [priority queue](/computer-science-notes/data-structures-and-algorithms/queue#priority-queue), which is often implemented using [min-heap](/computer-science-notes/data-structures-and-algorithms/heap) to keep track of the path with the currently minimum cost. It is also considered as [greedy algorithm](/computer-science-notes/data-structures-and-algorithms/greedy), because it traverses the optimal path first.
