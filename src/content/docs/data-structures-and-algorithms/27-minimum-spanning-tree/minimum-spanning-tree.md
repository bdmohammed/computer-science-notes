...
**Minimum Spanning Tree (MST)** is a concept in [graph](/computer-science-notes/data-structures-and-algorithms/graph), specifically in a [weighted graph](/computer-science-notes/data-structures-and-algorithms/graph#weighted), where we need to find the minimum possible total weight for connecting all the vertices. The real world application of this is to make the most effective connection between a set of locations.
...
**Prim's algorithm** is a [greedy algorithm](/computer-science-notes/data-structures-and-algorithms/greedy) that finds a minimum spanning tree for a [weighted](/computer-science-notes/data-structures-and-algorithms/graph#weighted) [undirected](/computer-science-notes/data-structures-and-algorithms/graph#undirected) graph.
...
Similar to [Dijkstra's algorithm](/computer-science-notes/data-structures-and-algorithms/shortest-path#dijkstras-algorithm), it uses priority queue to help to prioritize the minimum weight and a visited set to keep track the visited vertex.
