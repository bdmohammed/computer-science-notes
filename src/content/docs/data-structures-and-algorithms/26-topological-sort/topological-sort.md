...
**Topological Sort** is an algorithm used to order the vertices of a [directed graph](/computer-science-notes/data-structures-and-algorithms/graph#directed), so that each vertex appears before any of its successors in the ordering. It provides a linear ordering of the vertices that respects the directed edges of the graph.
...
The algorithm can be implemented using [DFS](/computer-science-notes/data-structures-and-algorithms/traversal#depth-first-search-dfs) or [BFS](/computer-science-notes/data-structures-and-algorithms/traversal#breadth-first-search-bfs) traversal.
