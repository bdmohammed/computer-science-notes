...
**Trie**, also known as **prefix tree**, is a type of [tree](/computer-science-notes/data-structures-and-algorithms/tree) data structure, which primarily used for efficient retrieval and storage of strings or sequences of characters.
