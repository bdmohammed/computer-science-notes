...
:::tip
Find out more about [how HTML works](/computer-science-notes/internet-and-web/web-browser#page-rendering).
:::
...
:::tip
DOM is not limited to HTML it is also used in **[Extensible Markup Language (XML)](/computer-science-notes/digital-media-processing/xml)** which is markup language used to store and transport data in a structured format. XML allows developers to define their own custom tags and elements, making it highly extensible and adaptable to a wide range of applications.
:::
...
:::tip
See how [JavaScript manipulates the DOM](/computer-science-notes/internet-and-web/javascript#dom-manipulation).
:::
