...
:::tip
See also [functional programming](/computer-science-notes/computer-and-programming-fundamentals/declarative-functional-programming#functional-programming).
:::
...
- **Prefix Notation**: Expression is written in [prefix notation](/computer-science-notes/compilers-and-programming-languages/control-flow#expression-evaluation), with input `(+ 3 4)`, the interpreter prints `7`.
