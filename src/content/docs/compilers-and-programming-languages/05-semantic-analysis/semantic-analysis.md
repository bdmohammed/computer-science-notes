...
In the compilation process, the AST is used to keep track of syntactical information. It is a data structure used by the compiler to generate code later on. Sometimes, it is transformed into an intermediate representation first, then into real machine code. The AST is frequently represented as linked structure, such as [linked list](/computer-science-notes/data-structures-and-algorithms/linked-list), [tree](/computer-science-notes/data-structures-and-algorithms/tree), or [graph](/computer-science-notes/data-structures-and-algorithms/graph) structure.
...
Using this, we effectively created a [linked list](/computer-science-notes/data-structures-and-algorithms/linked-list) with hierarchical and linked structure of declarations.
...
The symbol table is frequently accessed throughout many compilation steps. It is created during scanning and parsing. One common implementation for storing symbols is in a [hash table](/computer-science-notes/data-structures-and-algorithms/hash-table). Each entry could be contained within a struct that has several properties commonly associated with an identifier, such as name, type, scope, memory location, etc.
...
Attribute grammars are formal methods for specifying semantics of programming languages to a formal language like [context-free grammar](/computer-science-notes/theory-of-computation-and-automata/context-free-grammar).
...
Below is an example of a grammar of arithmetic expressions in [LR](/computer-science-notes/compilers-and-programming-languages/parsing#bottom-up-parsing).
...
We modified the [calculator language example](/computer-science-notes/compilers-and-programming-languages/parsing#recursive-descent-parser) to include types and declaration semantics. A sample program and its syntax tree as well as the production rule used to derive it can be seen below.
