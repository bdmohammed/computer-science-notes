...
:::tip
The two popular architecture are [CISC (e.g., x86)](/computer-science-notes/computer-organization-and-architecture/isa#cisc) and [RISC (e.g., ARM)](/computer-science-notes/computer-organization-and-architecture/isa#risc), see also [ISA](/computer-science-notes/computer-organization-and-architecture/isa).
:::
...
:::tip
See also [registers & ram](/computer-science-notes/computer-organization-and-architecture/registers-and-ram).
:::
...
Compiler needs to know the characteristics of memory, such as the [minimum memory to address](/computer-science-notes/computer-organization-and-architecture/coa-fundamentals#word-size), [padding](/computer-science-notes/computer-organization-and-architecture/coa-fundamentals#padding), [endianness](/computer-science-notes/computer-organization-and-architecture/coa-fundamentals#endianness), [floating-point representation](/computer-science-notes/computer-and-programming-fundamentals/floating-number#floating-number-representation), [binary representation](/computer-science-notes/computer-and-programming-fundamentals/binary-representation#binary-representation) or the size of data types.
...
[Instruction set architecture (ISA)](/computer-science-notes/computer-organization-and-architecture/isa) is the set of instruction offered by the machine that the running program must follow in order to control the CPU.
...
CPU uses technique like [pipelining](/computer-science-notes/computer-organization-and-architecture/cpu-design#pipelining), in which instruction are executed in parallel. Sometimes, pipeline doesn't always work and may not work optimally, these problems are often called as hazards.
...
:::info
This example uses an intermediate representation called [three-address code (TAC)](/computer-science-notes/compilers-and-programming-languages/intermediate-representation#linear-ir).
:::

:::tip
More about [register allocation](/computer-science-notes/compilers-and-programming-languages/compiler-optimization#register-allocation).
:::
