...
:::note
Compression is considered a form of [encoding](/computer-science-notes/digital-signal-processing/encoding-and-decoding), which converts a signal or data into a specific format for transmission or storage, and then involves recovering the original signal or data from its encoded representation.
:::
...
2. **Huffman Tree Construction**: Using the frequency table, we will construct a [binary tree](/computer-science-notes/data-structures-and-algorithms/tree#binary-tree), where the child-most node is the less frequent data and the top most is the most frequent data. From the child node, we will merge the two of the lowest frequency to create the parent node that represents their frequency sum. We will keep doing this up to the top most node.
...
Transform coding is a general concept of lossy compression that involves transforming the original data into a different domain or representation. That new representation is then analyzed and processed to achieve desired result. They are algorithm like [discrete cosine transform (DCT)](/computer-science-notes/digital-signal-processing/discrete-cosine-transform), [discrete Fourier transform (DFT)](/computer-science-notes/digital-signal-processing/discrete-fourier-transform) and [wavelet transform](/computer-science-notes/digital-signal-processing/wavelets).
...
:::tip
Other lossy compression for [images (JPG/JPEG)](/computer-science-notes/digital-media-processing/jpg-jpeg), [audio (MP3)](/computer-science-notes/digital-media-processing/mp3), and [video (MP4)](/computer-science-notes/digital-media-processing/mp4).
:::
