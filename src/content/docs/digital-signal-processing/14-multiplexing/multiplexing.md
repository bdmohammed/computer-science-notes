...
Only a single [medium](/computer-science-notes/digital-signal-processing/signal-transmission-medium) (also called a channel) is needed to transmit multiple signals. This saves bandwidth, capacity, and the cost of the physical infrastructure required for transmission.
...
WDM combines multiple signals onto a single transmission medium by separating each signals by their wavelength. WDM is typically transmitted together through an [optical fiber](/computer-science-notes/digital-signal-processing/signal-transmission-medium#guided-transmission).
