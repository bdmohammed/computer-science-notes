...
**Fast Fourier transform (FFT)** algorithm is a fast and efficient algorithm for computing the [Discrete Fourier transform (DFT)](/computer-science-notes/digital-signal-processing/discrete-fourier-transform) of a sequence of $N$ complex numbers. FFT improves a quadratic complexity $O(N^2)$ algorithm to a linearithmic $O(N \: log (N))$ speed.

:::tip
More about [algorithm complexity](/computer-science-notes/data-structures-and-algorithms/analysis-of-algorithms#big-o-notation).
:::
...
:::info
FFT algorithm use the [divide-and-conquer algorithm strategy](/computer-science-notes/data-structures-and-algorithms/divide-and-conquer). FFT divides problem into smaller subproblems and solve it recursively, which makes computation more efficient.
:::
