...
**Residual Network (ResNet)** is a type of [neural network](/computer-science-notes/deep-learning/neural-network) developed to address the problem of training a very deep neural network (consist many hidden layers). It is to address the [vanishing gradient problem](/computer-science-notes/deep-learning/neural-network#vanishing-gradient-problem), which occurs in the learning process of neural network, specifically in the backpropagation process.
...
Residual block is the building block of ResNet, it combines each individual layer that includes [convolution layer](/computer-science-notes/deep-learning/cnn#convolution-1), [pooling layer](/computer-science-notes/deep-learning/cnn#pooling-1), activation function, and any other layer with the skip connection.
