...
**U-Net** is a U-shaped [convolutional neural network](/computer-science-notes/deep-learning/cnn) architecture that follows the encoder-decoder network with a [skip connection](/computer-science-notes/deep-learning/resnet#residual-connection).
