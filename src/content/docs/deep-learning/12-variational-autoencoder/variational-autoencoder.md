...
Input data such as image is fed to the encoder. Similar to traditional autoencoder, it consist of several layers such as [convolution layers](/computer-science-notes/deep-learning/cnn#convolution-1) and [pooling layers](/computer-science-notes/deep-learning/cnn#pooling-1).
