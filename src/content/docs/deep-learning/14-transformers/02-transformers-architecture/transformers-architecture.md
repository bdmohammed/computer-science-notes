...
**Transformers** is a type of deep learning architecture that specifically uses the [attention mechanism](/computer-science-notes/deep-learning/transformers/attention-mechanism) as the key component. While [RNN with attention](/computer-science-notes/deep-learning/transformers/attention-mechanism#rnn-with-attention) also use the attention mechanism, transformers is a standalone architecture that doesn't need traditional sequential model like [RNN](/computer-science-notes/deep-learning/rnn).
