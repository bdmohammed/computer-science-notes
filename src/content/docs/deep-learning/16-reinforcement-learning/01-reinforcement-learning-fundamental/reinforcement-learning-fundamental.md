...
:::note
We can also combine RL with deep learning techniques, this is called **Deep Reinforcement Learning (Deep RL)**, techniques like [convolutional neural networks (CNN)](/computer-science-notes/deep-learning/rnn) or [recurrent neural networks (RNN)](/computer-science-notes/deep-learning/rnn) are used.
:::
...
In practice, the [value function](/computer-science-notes/deep-learning/reinforcement-learning/reinforcement-learning-fundamental#value-function) is usually not known to us. There are several reasons for this:
...
Bellman equation is an equation, typically used in [dynamic programming](/computer-science-notes/data-structures-and-algorithms/dynamic-programming), it is an equation that decompose a problem into smaller subproblems and finding the optimal solution by iteratively updating the value.
