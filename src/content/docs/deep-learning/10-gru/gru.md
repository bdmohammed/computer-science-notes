...
**Gated Recurrent Unit (GRU)** is a type of [recurrent neural network (RNN)](/computer-science-notes/deep-learning/rnn) and also the alternative of [long short-term memory](/computer-science-notes/deep-learning/lstm). GRU was developed to address LSTM limitation. LSTM has a complex architecture with different cell state and hidden state, making it computationally expensive.
