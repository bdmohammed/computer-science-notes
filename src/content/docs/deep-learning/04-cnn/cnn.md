...
**Convolutional Neural Network(CNN)** is a type of [neural network](/computer-science-notes/deep-learning/neural-network) that is specifically designed for processing grid-like data such as images.
